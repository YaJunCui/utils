...
struct tagICMP_ECHO_REPLY
{
    ...
    tagIP_OPTION_INFORMATION Options;       // Reply options
};

//typedef IP_OPTION_INFORMATION FAR* LPIP_OPTION_INFORMATION;
typedef tagIP_OPTION_INFORMATION FAR* LPIP_OPTION_INFORMATION;

typedef tagICMP_ECHO_REPLY FAR* LPICMP_ECHO_REPLY;
...
public:
    //Methods
#ifdef CPING_USE_ICMP
    BOOL Ping1(LPCTSTR pszHostName, CPingReply& pr, UCHAR nTTL = 10, DWORD dwTimeout = 2000, UCHAR nPacketSize = 32) const;
#endif
